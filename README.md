...
[![LLMs](https://img.shields.io/badge/LLMs-Ollama%20%2F%20Groq%20Cloud-orange)](https://ollama.com/)
[![Framework](https://img.shields.io/badge/Framework-React%20%2B%20Vite%20%2B%20TailwindCSS-black)](https://vite.dev/)
[![License](https://img.shields.io/badge/License-MIT-yellow)](https://github.com/ayush22cp008/ZENI-thinking-partner/blob/main/LICENSE)
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Vercel-brightgreen)](https://zeni-thinking-partner.vercel.app/)

---

## 🚀 Live Demo

**Try it here → [https://zeni-thinking-partner.vercel.app/](https://zeni-thinking-partner.vercel.app/)**

> The live demo runs on **Groq Cloud** (Demo Mode) so no local setup is needed — open the link and start using it instantly.

> **Note:** The current version is optimized for desktop/laptop workflows with a primary focus on fast iteration, AI orchestration, and developer-centric usability.
...
- [Ollama](https://ollama.com/) (Required for local/private mode only)
...
This project is licensed under the [MIT License](https://github.com/ayush22cp008/ZENI-thinking-partner/blob/main/LICENSE).
